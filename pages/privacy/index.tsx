...
const PrivacyPage = () => (
  <>
    ...
    <div className='container mx-auto my-5'>
      ...
      <h2 className='my-5 text-2xl'>Interpretation</h2>
      <p>
      ...
      <h2 className='my-5 text-2xl'>Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to AG Logia, 22 Mercedes Drive, ON, M9V 4T5.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to AG Logia, accessible from
            <a href='www.aglogia.com' rel='noreferrer' target='_blank'>
              www.aglogia.com
            </a>
          </p>
        </li>
      ...
      <h2 className='my-5 text-2xl'>Types of Data Collected</h2>
      <h3>Personal Data</h3>
      <p>
      ...
      <h2 className='my-5 text-2xl'>Use of Your Personal Data</h2>
      ...
      <h2 className='my-5 text-2xl'>Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className='my-5 text-2xl'>Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 className='my-10 text-2xl'>Disclosure of Your Personal Data</h2>
      ...
      <h2 className='my-5 text-2xl'>Security of Your Personal Data</h2>
      <p>
      ...
      <ul>
        <li>By email: info@aglogia.com</li>
      </ul>
    </div>
